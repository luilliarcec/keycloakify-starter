...
export default function LoginUpdateProfile(props: LoginUpdateProfileProps) {
    ...
    return (
        ...
        >
            <form id="kc-update-profile-form" className="flex flex-col gap-6" action={url.loginAction} method="post">
                ...
                <div className={kcClsx("kcFormGroupClass")}>
                    ...
                    <div id="kc-form-buttons" className="flex flex-col space-y-2">
                        <Button type="submit" disabled={!isFormSubmittable} className="w-full" value={msgStr("doSubmit")}>
                            {msgStr("doSubmit")}
                        </Button>
                        {isAppInitiatedAction && (
                            <Button type="submit" className="w-full" name="cancel-aia" value="true" formNoValidate>
                                {msgStr("doCancel")}
                            </Button>
                        )}
                    </div>
