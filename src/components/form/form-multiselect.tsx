...
export default function FormMultiselect(props: FormInputProps) {
    ...
    return (
        <DropdownMenu>
            <DropdownMenuTrigger
                className={cn(
                    "border-input file:text-foreground placeholder:text-muted-foreground selection:bg-primary selection:text-primary-foreground flex h-9 w-full min-w-0 rounded-md border bg-transparent px-3 pt-2 pb-1 text-base shadow-xs transition-[color,box-shadow] outline-none file:inline-flex file:h-7 file:border-0 file:bg-transparent file:text-sm file:font-medium disabled:pointer-events-none disabled:cursor-not-allowed disabled:opacity-50 md:text-sm",
            ...
            >
                {valueOrValues.length - 1} Items selected
            </DropdownMenuTrigger>
